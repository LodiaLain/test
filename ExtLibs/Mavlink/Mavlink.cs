...
public partial class MAVLink
{
    ...
    public static readonly message_info[] MAVLINK_MESSAGE_INFOS = new message_info[] {
        ...
        new message_info(229, "SG_CTRL_CMD_BITMASK", 46, 3, 3, typeof( mavlink_sg_ctrl_cmd_bitmask_t )),
...
///                MAV_CMD_NAV_ROI). </summary>
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 1, Size = 3)]
    ///<summary> RPM sensor output. </summary>
    public struct mavlink_sg_ctrl_cmd_bitmask_t
    {
        /// <summary>landing_gear_i2c.   </summary>
        public byte landing_gear_i2x;
        /// <summary>common gimbal control.   </summary>
        public byte gimbal;
